<template>
	<div
		class="modal fade"
		:id="`update_album${album_id}_modal`"
		tabindex="-1"
		role="dialog"
		aria-hidden="true"
	>
				...
				<form @submit="update_album">
					<div class="modal-body">
						...
						<div
							...
							v-if="success"
						>
							Album updated successfully (now you have to reload
							the page.)
						</div>
					</div>
...
export default {
	...
	methods: {
		...
		async update_album(e) {
			...
			if (this.album_name) form_data.append("name", this.album_name)

			if (this.album_artist)
				form_data.append("artist_id", this.album_artist)

			if (this.album_year) form_data.append("year", this.album_year)
