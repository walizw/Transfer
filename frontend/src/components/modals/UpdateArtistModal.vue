				...
				<form @submit="update_artist">
					<div class="modal-body">
						...
						<div
							...
							v-if="success"
						>
							Artist updated successfully (now you have to reload
							the page.)
						</div>
					</div>
...
export default {
	...
	methods: {
		...
		async update_artist(e) {
			...
			if (this.artist_name) form_data.append("name", this.artist_name)

			if (this.artist_bio)
				form_data.append("bio", this.artist_bio ? this.artist_bio : "")

			if (this.artist_pfp) form_data.append("pfp", this.artist_pfp)
