	...
	<div class="content__left">
		...
		<section class="playing">
			...
			<div class="playing__song">
				<router-link
					class="playing__song__name text-truncated"
					:to="
						playing_song
							? `/artist/${playing_song.artist.id}/#album_${name_id}`
							: '#'
					"
				>
				...
				<router-link
					:to="
						playing_song ? `/artist/${playing_song.artist.id}` : '#'
					"
				>
